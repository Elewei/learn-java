...
<html>
  <head> 
    <title>校内首页面</title>
    <link rel="stylesheet" href="/sns/css/common.css" type="text/css"/>
  	<link rel="stylesheet" href="/sns/css/index.css" type="text/css"/>
  </head>
  <body>
  	<!-- 引入头页面 -->
    ...
    <div class="main">
    	<div class="reg_login">
    		<div class="logForm">
    			<form action="/sns/login.do?flag=login" method="post">
    	...
    	<div class="banner1">
    		<img src="/sns/images/front/ay-0812-658-280.jpg" style="width: 719px;height: 306px;" />
    	</div>
    ...
    <!-- 注册第二个入口 -->
    	<div class="reg2">
    		...
    		<p> 校内存知己<br/>
    			<input type="image" onclick="" src="/sns/images/front/register.jpg" />
    		</p>
    	</div>
    ...
    <!-- 寻找你的朋友 -->
    	<div class="sea_friend">
    		...
    		<img src="/sns/images/front/sou.jpg" /><br/>
